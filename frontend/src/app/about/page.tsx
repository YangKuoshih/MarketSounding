      ...
      <section ref={heroRef} className="relative overflow-hidden border-b border-border">
        ...
        <div className="mx-auto max-w-5xl px-6 py-20">
          <motion.div style={{ y: heroY, opacity: heroOpacity }}>
            ...
            >
              MarketBuzz models how primary dealers respond to market events
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6 text-base leading-relaxed text-muted-foreground">
              <p>
                ...
                events have already moved markets. MarketBuzz bridges that
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  All dealer reactions in MarketBuzz are generated by AI
